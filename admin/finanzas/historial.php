...
<div class="bg-white shadow p-6 rounded-2xl">
  <h1 class="text-xl font-bold mb-2 text-blue-700"><?= TABS_FINANZAS['historial'] ?></h1>
  <p class="text-gray-500">Aquí irá el contenido del tab: <strong><?= TABS_FINANZAS['historial'] ?></strong>.</p>
</div>
